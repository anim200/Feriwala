  ...
  return (
    <Container>
        <Left>
            <Logo>Feriwala</Logo>
            <Desc>
            At Feriwala, we believe in the power of creativity to inspire and transform. Our platform is more than just a place to shop; its a vibrant community where artistry meets commerce. Explore our curated selection of unique products sourced from talented artisans and designers around the globe.
